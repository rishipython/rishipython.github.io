  ...
  <article class="card">
    ...
    <div class="content">
      ...
      <details>
        ...
        <div class="preview">
          <img src="{{ '/assets/img/papers/allnet.jpg' | relative_url }}" alt="allnet full preview" loading="lazy">
        </div>
        <div class="more">
  ...
  <article class="card">
    ...
    <div class="content">
      ...
      <details>
        <summary>read more</summary>
        <div class="preview">
          <img src="{{ '/assets/img/papers/parkinsons.jpg' | relative_url }}" alt="parkinson’s full preview" loading="lazy">
        </div>
        <div class="more">
  ...
  <article class="card">
    ...
    <div class="content">
      ...
      <details>
        <summary>read more</summary>
        <div class="preview">
          <img src="{{ '/assets/img/papers/one-eye.jpg' | relative_url }}" alt="one eye full preview" loading="lazy">
        </div>
        <div class="more">
